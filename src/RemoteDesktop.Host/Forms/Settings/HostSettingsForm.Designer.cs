...
partial class HostSettingsForm
{
    ...
    private void InitializeComponent()
    {
        ...
        layoutRoot.Size = new Size(740, 488);
        ...
        layoutFields.Controls.Add(new Label { AutoSize = true, Text = "MSSQL 連線字串", Anchor = AnchorStyles.Left }, 0, 0);
        layoutFields.Controls.Add(txtConnectionString, 1, 0);
        layoutFields.Controls.Add(new Label { AutoSize = true, Text = "Server URL", Anchor = AnchorStyles.Left }, 0, 1);
        layoutFields.Controls.Add(txtServerUrl, 1, 1);
        layoutFields.Controls.Add(new Label { AutoSize = true, Text = "主控台名稱", Anchor = AnchorStyles.Left }, 0, 2);
        layoutFields.Controls.Add(txtConsoleName, 1, 2);
        layoutFields.Controls.Add(new Label { AutoSize = true, Text = "管理帳號", Anchor = AnchorStyles.Left }, 0, 3);
        layoutFields.Controls.Add(txtAdminUserName, 1, 3);
        layoutFields.Controls.Add(new Label { AutoSize = true, Text = "管理密碼", Anchor = AnchorStyles.Left }, 0, 4);
        layoutFields.Controls.Add(txtAdminPassword, 1, 4);
        layoutFields.Controls.Add(new Label { AutoSize = true, Text = "共享金鑰", Anchor = AnchorStyles.Left }, 0, 5);
        layoutFields.Controls.Add(txtSharedAccessKey, 1, 5);
        layoutFields.Controls.Add(new Label { AutoSize = true, Text = "心跳逾時秒數", Anchor = AnchorStyles.Left }, 0, 6);
        layoutFields.Controls.Add(numHeartbeatTimeout, 1, 6);
        layoutFields.Controls.Add(new Label { AutoSize = true, Text = "HTTPS 轉址", Anchor = AnchorStyles.Left }, 0, 7);
        layoutFields.Controls.Add(chkRequireHttpsRedirect, 1, 7);
        layoutFields.Dock = DockStyle.Fill;
        layoutFields.Location = new Point(19, 63);
        layoutFields.Name = "layoutFields";
        layoutFields.RowCount = 8;
        for (var i = 0; i < 8; i++)
        {
