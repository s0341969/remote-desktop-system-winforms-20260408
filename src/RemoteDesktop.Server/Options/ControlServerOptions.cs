...
namespace RemoteDesktop.Server.Options;
...
public sealed class ControlServerOptions
{
    ...
    [Required]
    [Url]
    public string ServerUrl { get; init; } = "http://localhost:5206";

    [Required]
    [MinLength(3)]
    public string ConsoleName { get; init; } = "RemoteDesk Central Server";
